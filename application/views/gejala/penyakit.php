...
<body id="page-top">
        ...
        <?php $this->load->view("tambahan/navbar.php") ?>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Data Gabungan</h1>
                    <div class="content mt-3">
                        <div class="row">
                            <div class="col-sm-12" style="margin-bottom: 10px;">
                                <button href="dashboard.php?p=input_user" class="btn btn-success" onclick= "tambah()"><i class="fa fa-plus"></i> Tambah Gejala</button>
                            </div>
                        </div>
    ...
    <?php
        ...
        <div class="form-group mb-3">
            <label class="label" for="name">Penyakit</label>
            <select id="penyakit" class="form-control">
            ';
            foreach ($penyakit as $ind => $v) {
                $dt['form'].='<option value="'.$v['kdPenyakit'].'">'.$v['nmPenyakit'].'</option>';
            }
    ...
    <script>
       ...
       function ubah(){
        // return console.log(params);
           ...
           $.ajax({
               url:url+"index.php/aksi/updategejala",
               type:"post",
               data:params,
               success:function(resp){
                   alert(resp);
        ...
        function hapus(){
           ...
           $.ajax({
               url:url+"index.php/aksi/deletegejala",
               type:"post",
               data:params,
               success:function(resp){
                   alert(resp);
