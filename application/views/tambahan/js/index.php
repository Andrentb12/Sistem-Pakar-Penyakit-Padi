    ...
    <script src="<?php echo base_url('assets/js/data-table/datatables.min.js')?>"></script>
    ...
    <script src="<?php echo base_url('assets/js/data-table/datatables-init.js')?>"></script> 
...
<!--     
   ...
   <script src="<?php echo base_url('assets/js/data-table/buttons.bootstrap.min.js')?>"></script>
    ...
    <script src="<?php echo base_url('assets/js/data-table/buttons.print.min.js')?>"></script>
    <script src="<?php echo base_url('assets/js/data-table/buttons.colVis.min.js')?>"></script>
    <script src="<?php echo base_url('assets/js/data-table/datatables-init.js')?>"></script>  -->